---
title: Revised Grading Contract
date: "`r format(Sys.time(), '%B %d %Y')`"
output: github_document
params:
  weekonemonday: "2025-01-13"
  thesisdeadline: "2025-04-3"
  springbreak: "2025-03-8 - 2025-03-16"
  name: Ben Waggener
  labs: 11
  portfolios: 10
  grade:
...
- [ ] `r advdate(dayone, 4, topic)`
  - Finish Lab 4  by `r startweek`:  `r advdate(dayone, 9, assignment=startweek)`
- [ ] `r advdate(dayone, 5, topic)`
  - Finish Lab 5  by `r startweek`:  `r advdate(dayone, 10, assignment=startweek)`
  - Finish portfolio piece 2 by `r startweek`:  `r advdate(dayone, 9, assignment=startweek)`
- [ ] `r advdate(dayone, 6, topic)`
  - Finish Lab 6 by `r startweek`:  `r advdate(dayone, 11, assignment=startweek)`
  - Schedule a check-in with Mason by `r startweek`:  `r advdate(dayone, 11, assignment=startweek)`
- [ ] `r advdate(dayone, 7, topic)`
  - Finish Lab 7 by `r startweek`:  `r advdate(dayone, 11, assignment=startweek)`
